...
This project also serves as the upstream project in the dbt Mesh cross-project reference lab — its public models are consumed by the companion downstream [marketing project repo](https://github.com/dbt-labs/dbt-Summit-26-Marketing-Architect).
